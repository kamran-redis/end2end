...
#sum(rate(flink_taskmanager_job_task_operator_helloworld_MY2eventCounter[1m]))
#flink_taskmanager_job_task_operator_helloworld_MY1eventTimeLag{quantile="0.99"}
#avg(flink_taskmanager_job_task_operator_helloworld_MY1eventTimeLag{quantile="0.99"})
